export const translations = {
  ro: {
    ...
    about: {
      ...
      story: {
        ...
        text: 'Odette a luat naștere din pasiunea pentru patiserie fină și dorința de a aduce bucurie prin fiecare creație. Începută ca un vis modest, astăzi suntem mândri să oferim cele mai delicioase torturi și prăjituri din orașul nostru. Fiecare produs este realizat cu ingrediente premium și multă dragoste, respectând rețete tradiționale dar și inovând constant.'
      },
      mission: {
  ...
  en: {
    ...
    about: {
      ...
      story: {
        title: 'Our Story',
        text: 'Odette was born from a passion for fine pastries and the desire to bring joy through every creation. Started as a modest dream, today we are proud to offer the most delicious cakes and pastries in our city. Each product is made with premium ingredients and lots of love, respecting traditional recipes while constantly innovating.'
      },
      mission: {
        title: 'Our Mission',
