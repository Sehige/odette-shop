        ...
        <div className="p-6">
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div>
              ...
              {/* Flavor Selection */}
              {product.flavors && product.flavors[language] && product.flavors[language].length > 0 && (
                <div className="mb-6">
                  <label className="block text-sm font-semibold text-gray-900 mb-2">
              ...
              <div className="mt-8 space-y-4">
                ...
                {product.storage && (
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">{product.storage[language]}</p>
                  </div>
                )}
              </div>
            </div>
          ...
          {relatedProducts.length > 0 && (
            <div className="border-t pt-8">
              <h3 className="text-2xl font-bold mb-6" style={{ color: '#1e3a8a' }}>
                {language === 'ro' ? 'S-ar putea să vă placă și' : 'You might also like'}
              </h3>
